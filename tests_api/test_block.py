...
class TestBlockMoney:
    ...
    def test_03(self):
        ...
        assert 'False' == Api.requestBlock('test-03')

    @pytest.mark.Critical
    def test_04(self):
        """Send null value  in OrderId  field """
        assert 'False' == Api.requestBlock('test-04', charOrder='')
    ...
    def test_06(self):
        ...
        assert 'False' == Api.requestBlock('test-06', charOrder=51)

    @pytest.mark.Critical
    def test_07(self):
        """Send special characters in OrderId field """
        assert 'False' == Api.requestBlock('test-07', charOrder='~!@#$%%^&*()=_+<>?/')

    @pytest.mark.Critical
    def test_08(self):
        """Send different values in OrderId fields """
        assert 'False' == Api.requestBlock('test-08', differentOrderId=True)

    @pytest.mark.Critical
    def test_09(self):
        """Send null value in Amount fields """
        assert 'False' == Api.requestBlock('test-09')
    ...
    def test_11(self):
        ...
        assert 'False' == Api.requestBlock('test-11')

    @pytest.mark.Critical
    def test_12(self):
        """Send null value  in PAN fields """
        assert 'False' == Api.requestBlock('test-12')
    ...
    def test_18(self):
        ...
        assert 'False' == Api.requestBlock('test-18')
    ...
    def test_20(self):
        ...
        assert 'False' == Api.requestBlock('test-20')
    ...
    def test_30(self):
        ...
        assert 'False' == Api.requestBlock('test-30')
    ...
    def test_36(self):
        ...
        assert 'False' == Api.requestBlock('test-36')
    ...
    def test_41(self):
        ...
        assert 'False' == Api.requestBlock('test-41')
    ...
    def test_47(self):
        ...
        assert 'False' == Api.requestBlock('test-47', CustomFields=True)

    @pytest.mark.Minor
    def test_48(self):
        """Send some letters value  in IP"""
        assert 'False' == Api.requestBlock('test-48', CustomFields=True)

    @pytest.mark.Minor
    def test_49(self):
        """Send value without dots  in IP"""
        assert 'False' == Api.requestBlock('test-49', CustomFields=True)

    @pytest.mark.Minor
    def test_50(self):
        """Send dots in wrong places e  in IP"""
        assert 'False' == Api.requestBlock('test-50', CustomFields=True)
